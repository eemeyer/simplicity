 ...
 *     $('#map').simplicityBingMapOriginial({
 ...
 */
(function ($) {
  $.widget("ui.simplicityBingMapOriginial", {
    /**
     * Widget options.
     *
     * <dl>
     ...
     *   </dd>
     * </dl>
     * @name $.ui.simplicityBingMapOriginial.options
     */
    options : {
      searchElement: 'body',
    ...
    _create : function () {
      this.element.addClass('ui-simplicity-bing-map-original');
      this._markers = [];
      this._boundsShapes = [];
     ...
     *
     * @name $.ui.simplicityBingMapOriginial._initWhenAvailable
     * @function
     * @private
     */
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.map
     * @function
     */
    map: function () {
      return this._map;
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.loadMap
     * @function
     * @private
     */
    loadMap: function () {
     ...
     * any map markers.
     *
     * @name $.ui.simplicityBingMapOriginial.refreshMap
     * @function
     */
    refreshMap: function () {
     ...
     *
     * @name $.ui.simplicityBingMapOriginial._resultSetHandler
     * @function
     * @private
     */
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.removeMarkers
     * @function
     */
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.addMarkers
     * @function
     */
    ...
    _mapBoundsChangeHandler: function () {
      ...
      if (this.options.debug) {
        console.log('simplicityBingMapOriginial: Bounds changed', bounds);
      }
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.bounds
     * @function
     */
    bounds: function () {
     ...
     * @name $.ui.simplicityBingMapOriginial.normalizeBounds
     * @function
     * @private
     */
     ...
     *
     * @name $.ui.simplicityBingMapOriginial.hideBounds
     * @function
     * @private
     */
    hideBounds: function () {
     ...
     * @name $.ui.simplicityBingMapOriginial.showBounds
     * @function
     * @private
     */
    ...
    destroy: function () {
      this.element.removeClass('ui-simplicity-bing-map-original');
